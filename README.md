# 🌐 BBKitchen Storefront (Public Web & Catalog)

> **Public Storefront, Next.js 15 Web, Dynamic Product Catalog, WhatsApp Direct Checkout & Enterprise SEO Suite.**
...
- **Data Fetching:** Hybrid SSR & ISR via API proxy to Control Tower / WordPress
- **Checkout:** WhatsApp Direct Order Engine with pre-filled SKU & pricing payload
...
## 🚀 Recent Sprints (Top 10)

> Etalase 10 sprint kerja teknis terakhir di modul `bbk-storefront`. Riwayat lengkap di [`docs/progress/README.md`](docs/progress/README.md).
...
| **BBK-2.14** | [`BBK-2.14.md`](../Jarvis-OS/domains/business/bbkitchen/docs/progress/BBK-2.14.md) | 2026-09-21 21:21 WIB | **2h 33m** | Dynamic RBAC & Granular 18-Key PBAC | 1 | 🔒 Sealed |
...
| **BBK 2.8** | [`BBK-2.8.md`](../Jarvis-OS/domains/business/bbkitchen/docs/progress/BBK-2.8.md) | 2026-08-30 01:57 WIB | 5h 20m | Sales Quote preserved, Sales Helper proxy to BTC & deployment recovery | 1 | 🔒 Sealed |

---


## 🧭 Navigasi & Dokumentasi
- 📈 **Sesi Koding Teknis:** [`docs/progress/README.md`](docs/progress/README.md) (`fn_start BBK` / `fn_close`)
