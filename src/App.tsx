  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col font-sans selection:bg-amber-400 selection:text-slate-950">
      ...
      <div className="relative">
        ...
        <img src="/images/people/bbkitchen-team-thumbs-up.webp" alt="BBKitchen" className="hidden xl:block absolute right-[5%] bottom-[-18px] w-[210px] max-h-[360px] object-contain pointer-events-none drop-shadow-xl" />
      </div>
