        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden sm:inline text-slate-400">
              Peralatan Dapur Komersial Bekas & Rekondisi Teruji
            </span>
          </div>
              ...
              {pinInputOpen && (
                <div className="absolute right-0 top-7 w-64 bg-slate-900 border border-slate-700 rounded-lg p-3 shadow-xl z-50 text-slate-200">
                  ...
                  <p className="text-[11px] text-slate-400 mb-2">
                    Masukkan PIN staff untuk melihat kontrol READY/SOLD dan catatan internal. (PIN Demo: <strong>1234</strong>)
                  </p>
                  <form onSubmit={handlePinSubmit} className="space-y-2">
                    <input
                      ...
                      autoFocus
                      className="w-full px-2.5 py-1 bg-slate-950 border border-slate-700 rounded text-xs text-white focus:outline-none focus:border-amber-400"
                    />
                    ...
                    <div className="flex justify-end gap-2 pt-1">
                      ...
                      <button
                        type="submit"
                        className="px-3 py-1 bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold text-[11px] rounded"
                      >
                        Buka Akses
                      </button>
                    </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6">
        ...
        <div className="flex items-center justify-between w-full md:w-auto">
          ...
          <button
            ...
            className="md:hidden inline-flex items-center gap-1 px-3 py-1.5 bg-amber-500/20 text-amber-300 border border-amber-500/40 rounded-lg text-xs font-semibold"
          >
        ...
        <div className="w-full md:max-w-xl relative">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Cari kompor 4 burner, deep fryer, chiller, mixer 20L, meja stainless..."
              className="w-full pl-10 pr-10 py-2 sm:py-2.5 bg-slate-950/90 border border-slate-700 rounded-xl text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:border-amber-400 transition-all"
            />
            {searchQuery && (
              <button
                type="button"
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold shadow-md shadow-emerald-950 transition-colors"
          >
          ...
          {isAdminMode && (
            <button
              type="button"
              id="header-open-admin-panel-btn"
              onClick={onOpenAdminPanel}
              className="inline-flex items-center gap-1.5 px-3 py-2 bg-amber-500 text-slate-950 font-bold rounded-xl text-xs shadow-md transition-colors hover:bg-amber-400"
            >
        ...
        <div className="bg-amber-500/10 border-t border-b border-amber-500/30 px-4 py-1.5 text-xs text-amber-300">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span>
                <strong>Mode Staff / Admin Aktif:</strong> Anda dapat mengubah status READY/SOLD, melihat catatan internal & ID referensi Telegram sumber. (Data internal ini 100% tersembunyi dari publik).
              </span>
            </div>
            <button
              type="button"
              onClick={onOpenAdminPanel}
              className="underline text-amber-200 hover:text-white text-xs font-medium ml-3 shrink-0"
            >
              Buka Panel Inventori →
            </button>
          </div>
        </div>
      )}
