...
function getConditionLabel(condition: string | undefined): 'Baru' | 'Bekas' | null {
  ...
  if (normalized === 'BEKAS' || normalized.includes('BEKAS') || normalized.includes('REKONDISI')) return 'Bekas';
  return null;
}
    ...
    >
      <div>
        ...
        <div className="p-4 space-y-3">
          ...
          <p className="text-xs text-slate-500 line-clamp-2 leading-relaxed">{product.summary}</p>
        </div>
      </div>
