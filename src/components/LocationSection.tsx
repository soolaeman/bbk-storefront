  ...
  return (
    <section className="bg-slate-100 py-12 px-4 border-b border-slate-200">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1fr_0.35fr] gap-6 items-stretch">
          ...
          <div className="relative min-h-[260px] lg:min-h-[390px] overflow-hidden flex items-end justify-center lg:justify-end">
            <img
              src="/images/people/bbkitchen-chef-pointing.webp"
              alt="Chef BBKitchen menunjuk ke lokasi"
              className="absolute bottom-0 right-0 h-[290px] sm:h-[340px] lg:h-[410px] w-auto max-w-none object-contain object-bottom"
            />
          </div>
        </div>
      </div>
