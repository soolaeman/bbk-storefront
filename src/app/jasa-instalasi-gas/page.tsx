    ...
    <div className="min-h-screen bg-slate-100 text-slate-900 font-sans">
      ...
      <main>
        <section className="relative overflow-hidden bg-slate-950 text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-20 lg:py-24"><div className="max-w-3xl"><p className="text-xs font-black uppercase tracking-[0.22em] text-emerald-400">BBKitchen • Instalasi Gas</p><h1 className="mt-4 text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.02]">Jasa Instalasi Gas, Ducting, Hood dan Exhaust</h1><p className="mt-6 max-w-2xl text-sm sm:text-base leading-7 text-slate-300">Layanan instalasi gas, ducting, hood dan exhaust yang disesuaikan dengan layout, kebutuhan equipment, dan kondisi dapur komersial Anda.</p><a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 text-sm font-black text-white hover:bg-emerald-400 transition-colors"><MessageCircle className="w-4 h-4" />Konsultasi Instalasi <ArrowRight className="w-4 h-4" /></a></div></div>
        </section>
